...
import json
import base64
from user import codeUser, codePwd
...
class DamatuApi():
    ...
    # url地址打码 参数 url地址
    # type是类型(类型查看http://wiki.dama2.com/index.php?n=ApiDoc.Pricedesc) return
    # 是答案为成功 如果为负数 则为错误码
...
dmt = DamatuApi(codeUser, codePwd)
# #2.调用方法：
# #print(dmt.getBalance()) #查询余额
# if __name__ == '__main__':
# 	print(dmt.decode('0349.bmp',287)) #上传打码
...
def codes(filepath, type):
    codeStr = dmt.decode(filePath=filepath, type=type)
